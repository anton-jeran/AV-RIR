...
class Encoder(torch.nn.Module):
    def __init__(self,
        ...
        self.encode_RIR = torch.nn.Sequential(
            torch.nn.Conv1d(input_channels, 16*in_channels, 9601, 150, 4800, bias=False),
        ...
        self.encode_RIR_s = torch.nn.Sequential(
            torch.nn.Conv1d(in_channels, 16*in_channels, 9600, 500, 4800, bias=False),
            torch.nn.LeakyReLU(0.2, inplace=True),
            # state size. (ndf) x 1024
